...
SECRET_KEY = "django-insecure-)0l_%l9gf9@7urz^p$7yienw6dzc$ablkog7q94-w=4*_h6^rg"
...
# Спільні статичні файли проєкту (css, js, картинки шаблонів)
STATICFILES_DIRS = [BASE_DIR / "static"]

# Куди collectstatic збирає файли для продакшену
STATIC_ROOT = BASE_DIR / "staticfiles"

# Media files (файли, які завантажують користувачі)
